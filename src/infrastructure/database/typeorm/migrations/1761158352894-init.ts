...
export class Init1761158352894 implements MigrationInterface {
    name = 'Init1761158352894'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "core"."delivery" ADD CONSTRAINT "FK_e1a5374a7f5c51edf274fc15483" FOREIGN KEY ("userId") REFERENCES "core"."user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "core"."seen_listing" ADD CONSTRAINT "FK_bd8126e5780e6bf44654b7bac8e" FOREIGN KEY ("subscriptionId") REFERENCES "core"."subscription"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "core"."subscription" ADD CONSTRAINT "FK_cc906b4bc892b048f1b654d2aa0" FOREIGN KEY ("userId") REFERENCES "core"."user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
